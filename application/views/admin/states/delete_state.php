...
?>
 ...
 <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><?=keyword_value('delete_state','Delete State')?></h1>
					<a href="<?=base_url('admin/states')?>" class="btn btn-primary text-right"><?=keyword_value('back','Back')?></a>
