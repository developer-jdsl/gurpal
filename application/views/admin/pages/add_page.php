...
?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><?=keyword_value('add_page','Add Page')?></h1>
                        ...
                        <div class="card-body">
                            <?php echo validation_errors();?>
									...
									<?php echo form_open_multipart('admin/add_page'); ?>
											...
											<div class="col-md-6">
											 <div class="form-group">
												<label><?=keyword_value('page_name','Page Name')?></label>
													<input type="text" name="page_name" class="form-control form-control-user" value="<?=set_value('page_name')?>" required>
												</div>
										...
										<option value="1" <?php if(set_value('active')==1) { echo 'selected';} ?>>Active</option>
										<option value="0" <?php if(set_value('active')==0) { echo 'selected';} ?>>Inactive</option>
										</select>
										...
										<option value="1" <?php if(set_value('show_on_menu')==1) { echo 'selected';} ?>>Yes</option>
										<option value="0" <?php if(set_value('show_on_menu')==0) { echo 'selected';} ?>>No</option>
										</select>
										...
										<div class="col-md-6">
										 ...
										 <div class="form-group">
												...
												<label><?=keyword_value('meta_keywords','Meta Keywords')?></label>
													<input type="text" name="meta_keywords" class="form-control form-control-user" value="<?=set_value('meta_keywords')?>"  >
												</div>
												...
												<label><?=keyword_value('meta_description','Meta Description')?></label>
													...
													<textarea name="meta_description" class="form-control form-control-user" rows="5"><?=set_value('meta_description')?></textarea>
												</div>
											...
											<div class="col-md-12">
												...
												<label><?=keyword_value('page_content','Page Content')?></label>
													...
													<textarea name="page_content"   class="form-control form-control-user editor" rows="10"><?=set_value('page_content')?></textarea>
												</div>
