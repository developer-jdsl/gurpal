...
?>
 ...
 <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><?=keyword_value('edit_profile','Edit Profile')?></h1>
                    ...
                    <div class="card shadow mb-4 mt-4 mc col-md-12">
                        ...
                        <div class="card-body">
								...
								<div class="col-md-6">
										...
										<select name="profile_package" class="form-control form-control-user" disabled>
										...
										<select name="profile_categories[]" class="form-control form-control-user select_2" multiple>
										...
										<div class="col-md-6">
										 <div class="form-group">
										<label><?=keyword_value('profile_name','Business Name')?></label>
                                            <input type="text" name="profile_name" class="form-control form-control-user" value="<?=@$results['profile_name']?>" required>
                                        </div>
										
										 <div class="form-group">
										<label><?=keyword_value('profile_contact','Business Contact')?></label>
                                            <input type="text" name="profile_contact" class="form-control form-control-user" value="<?=@$results['profile_contact']?>">
                                        </div>
										
										<div class="form-group">
										<label><?=keyword_value('profile_address','Business Address')?></label>
                                        
											<textarea name="profile_address" class="form-control form-control-user" ><?=@$results['profile_address']?></textarea>
                                        </div>
										
										<?php if($results['profile_banner']){?>
										   <img src="<?=base_url('uploads/banners/'.$results['profile_banner'])?>" width="100%">
										   <?php } ?>
										   
										   
											<div class="form-group">
										<label><?=keyword_value('profile_banner','Profile Banner')?></label>
                                            <input type="file" accept="png,jpg,jpeg,gif" name="profile_banner" class="form-control form-control-user" >
                                        </div>
